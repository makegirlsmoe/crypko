...
To address these issues, we plan to leverage Ethereum layer 2 scaling solutions such as \cite{poon2017plasma} into the next version of Crypko, in order to make the transactions easier in terms of time and fee, 
