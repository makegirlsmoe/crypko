...
The year of 2018 sees artificial intelligence and blockchain attracting wide attention. % attract is not a complete action, better use -ing | agree
However, most general people feel it hard to understand or only partially understand either technology. Researchers and mass media provide beautiful blueprints, but people do not know the current stage of development in AI and blockchain, what they two can do, and how they are changing our lives. % better be specific to AI and blockchain only?
...
\item To add some fun to the game, Two existing NFTs can breed a new NFT.
\end{enumerate}
...
\item A person purchase a collectible because it matches his or her perception of beauty. However, when market values NFT that are rare (as specified by game providers) rather than aesthetically pleasing, NFTs cease to demonstrate their intrinsic value and beauty, degrading to bargaining chips. 
\end{itemize}
